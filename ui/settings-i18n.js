...
const TRANSLATIONS = {
  zh: {
    ...
    services: {
      ...
      roundRobin: '按权重优先 + 同权重轮询 + 自动故障切换',
      enable: '启用',
      disable: '停用',
      remove: '删除',
      priority: '权重',
      priorityHint: '数值越大优先级越高',
      priorityFailed: '更新账号权重失败。',
      noAccounts: '暂无已连接账号',
    ...
    codex: {
      selectFailed: '登录失败',
      selectFailedMessage: '登录 Codex 账号失败。',
      authTitle: 'Codex 认证',
      ...
      switchLocalAuth: '登录 Codex',
      switchConfirmTitle: '登录 Codex',
      switchConfirmMessage: ({ email, path }) => `确认将该账号写入 Codex 本地登录文件，用于登录 Codex 吗？\n\n账号：${email}\n目标文件：${path}`,
      switchSuccess: '登录成功',
      switchSuccessMessage: ({ email, path }) => `已将账号写入 Codex 本地登录文件，可用于登录 Codex。\n\n账号：${email}\n目标文件：${path}`,
      switchFailed: '登录 Codex 账号失败',
      switchMissingAccessToken: '当前 Codex 账号缺少 access token，无法登录 Codex。'
    },
    kiro: {
    ...
    tokenStats: {
      ...
      reasoning: '思考 Token',
      requests: '请求数',
      persistent: '历史账本默认保留最近 120 天，除非你在基础设置中手动清除。',
      noData: '该账号还没有可展示的 Token 统计。',
      noAccounts: '当前还没有可展示的账号。',
      historyAccount: '历史账号',
      unattributedAccount: '未归因账号',
      unattributedBadge: '未归因',
      unknownProvider: '未知服务',
      overviewTab: '总览',
      dailySummaryTab: '每日统计',
      dailyTab: '每日明细',
      dailySummaryTitle: '每日消耗统计',
      dailyTitle: '每日消耗明细',
      dateFilter: '日期查询',
      accountFilter: '账号筛选',
      allAccounts: '全部账号',
      clearDate: '全部日期',
      dailySummaryTableEmpty: '没有符合条件的每日统计数据。',
      dailyTableEmpty: '没有符合条件的每日消耗明细。',
      dailyPageInfo: ({ page, pages, total }) => `第 ${page} / ${pages} 页，共 ${total} 条`,
      previousPage: '上一页',
      nextPage: '下一页',
      dailyDate: '日期',
      dailyProvider: '服务',
  ...
  en: {
    ...
    services: {
      ...
      roundRobin: 'Priority first, round-robin within the same weight, with auto-failover',
      enable: 'Enable',
      disable: 'Disable',
      remove: 'Remove',
      priority: 'Weight',
      priorityHint: 'Higher values are used first',
      priorityFailed: 'Failed to update account weight.',
    ...
    codex: {
      selectFailed: 'Login Failed',
      selectFailedMessage: 'Failed to log in to Codex.',
      ...
      switchLocalAuth: 'Log in to Codex',
      switchConfirmTitle: 'Log in to Codex',
      switchConfirmMessage: ({ email, path }) => `Write this account to Codex local auth and use it to log in to Codex?\n\nAccount: ${email}\nTarget file: ${path}`,
      switchSuccess: 'Login Successful',
      switchSuccessMessage: ({ email, path }) => `This account was written to Codex local auth and can be used to log in to Codex.\n\nAccount: ${email}\nTarget file: ${path}`,
      switchFailed: 'Failed to log in to Codex',
      switchMissingAccessToken: 'The selected Codex account is missing an access token and cannot be used to log in to Codex.'
    },
    kiro: {
    ...
    tokenStats: {
      ...
      requests: 'Requests',
      persistent: 'Historical records keep the latest 120 days by default unless you clear them from Basic Settings.',
      ...
      unattributedAccount: 'Unattributed Account',
      unattributedBadge: 'Unattributed',
      unknownProvider: 'Unknown Service',
      overviewTab: 'Overview',
      dailySummaryTab: 'Daily Stats',
      dailyTab: 'Daily Details',
      dailySummaryTitle: 'Daily Consumption Statistics',
      dailyTitle: 'Daily Consumption Details',
      dateFilter: 'Date',
      accountFilter: 'Account',
      allAccounts: 'All Accounts',
      clearDate: 'All Dates',
      dailySummaryTableEmpty: 'No daily statistics match the current filter.',
      dailyTableEmpty: 'No daily consumption details match the current filter.',
      dailyPageInfo: ({ page, pages, total }) => `Page ${page} of ${pages}, ${total} rows`,
      previousPage: 'Previous',
      nextPage: 'Next',
      dailyDate: 'Date',
      dailyProvider: 'Service',
